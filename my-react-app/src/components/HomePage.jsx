...
const CameraIllustration = ({ width = 360 }) => (
  ...
  >
    {/* 地面三層：由深到淺冷灰（灰白風） */}
    <path d="M0 200 Q 90 140, 180 200 T 360 200 L 360 280 L 0 280 Z" fill="#B8BEC8" />
    <path d="M0 220 Q 120 160, 240 220 T 360 220 L 360 280 L 0 280 Z" fill="#CACFD6" />
    <path d="M0 240 Q 150 190, 300 240 L 360 240 L 360 280 L 0 280 Z" fill="#D8DDE3" />
    {/* 後方淺灰白矩形框 */}
    <rect x="45" y="70" width="135" height="100" rx="8" fill="#F0F1F4" />
    {/* 太陽：實心圓 + 六條放射光線 */}
    ...
    {/* 相機機身：立體扁平 - 石墨陰影面 */}
    <path d="M95 105 L95 215 L100 218 L100 108 Z" fill="#3A3F48" />
    <path d="M95 105 L265 105 L270 108 L100 108 Z" fill="#3A3F48" />
    {/* 機身主體 */}
    <rect x="100" y="108" width="165" height="105" rx="12" fill="#4A5058" />
    {/* 螢幕區域 */}
    <rect x="115" y="123" width="135" height="72" rx="8" fill="#8B9EB8" opacity={0.22} />
    {/* 閃光燈區域 */}
    <rect x="255" y="118" width="18" height="12" rx="3" fill="#A8B0BC" />
    {/* 熱靴槽 */}
    <rect x="155" y="98" width="55" height="10" rx="2" fill="#3A3F48" />
    <line x1="165" y1="103" x2="200" y2="103" stroke="#2D3138" strokeWidth="1" />
    <line x1="200" y1="103" x2="200" y2="108" stroke="#2D3138" strokeWidth="1" />
    {/* 記憶卡插槽 */}
    <rect x="268" y="145" width="12" height="35" rx="2" fill="#E4E6EA" />
    {/* 鏡頭：反光環＋同心圓（石板藍／石墨） */}
    <circle cx="182" cy="168" r="38" fill="#6B7A8A" />
    <circle cx="182" cy="168" r="32" fill="#3A3F48" />
    <circle cx="182" cy="168" r="26" fill="#2D3138" />
    <circle cx="182" cy="168" r="16" fill="#14181C" />
    {/* 快門按鈕 */}
    <circle cx="225" cy="125" r="7" fill="#D9A441" />
    {/* 底部裝飾線 + 刻度 */}
    <line x1="70" y1="265" x2="290" y2="265" stroke="#C5CAD2" strokeWidth="2" strokeLinecap="round" />
    {[90, 130, 170, 210, 250].map((x) => (
      <line key={x} x1={x} y1={262} x2={x} y2={268} stroke="#9AA3AE" strokeWidth="1.5" strokeLinecap="round" />
    ))}
    <circle cx="110" cy="265" r="4" fill="#D9A441" />
    <circle cx="182" cy="265" r="4" fill="#A8B4C4" opacity={0.85} />
    <circle cx="254" cy="265" r="4" fill="#A8B4C4" opacity={0.85} />
  </svg>
);
  ...
  return (
    <div className="homepage-psa" data-psa-home="true">
      <div className="homepage-psa__shell">
        ...
        <div className="homepage-psa__nav">
          <span className="homepage-psa__nav-brand">攝影風格助手</span>
          <div className="homepage-psa__nav-links">
            <span>計算器</span>
            <span>分析</span>
          </div>
        </div>

        <div className="homepage-psa__hero-rule" aria-hidden />

        <div className="homepage-psa__hero">
          <div className="homepage-psa__title-block">
            <p className="homepage-psa__eyebrow">PHOTOGRAPHY TOOL — VOL.01</p>
            <div className="homepage-psa__title-accent" aria-hidden />

            <div className="homepage-psa__title-row">
              <div className="homepage-psa__fstop-rail">
                <span>f/1.4</span>
                <span>f/2</span>
                <span>f/2.8</span>
                <span>f/4</span>
              ...
              <h1 className="homepage-psa__title">
                掌握<br />
                <em className="homepage-psa__title-em">光</em>的<br />
                語言
              </h1>
            </div>

            <div className="homepage-psa__title-foot">
              <span className="homepage-psa__shutter">1/125s · ISO 400 · f/2.8</span>
            </div>
          </div>

          <div className="homepage-psa__side">
            <div className="homepage-psa__ev-meter">
              <span className="homepage-psa__ev-label">EV</span>
              <div className="homepage-psa__ev-track">
                {[-3, -2, -1, 0, 1, 2, 3].map((v) => (
                  <div key={v} className={`homepage-psa__ev-tick${v === 0 ? " homepage-psa__ev-tick--center" : ""}`}>
                    <div className="homepage-psa__ev-line" />
                    <span>{v === 0 ? "±0" : v > 0 ? `+${v}` : v}</span>
                  </div>
                ))}
              </div>
            </div>
            <p className="homepage-psa__side-desc">
              從拍攝前的參數計算<br />
              到拍攝後的風格分析<br />
              完整的攝影輔助工作流程
            </p>

            <div className="homepage-psa__entries">
              <div
                className="homepage-psa__entry"
                onClick={() => onFeatureSelect("calculator")}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => (e.key === "Enter" || e.key === " ") && onFeatureSelect("calculator")}
              >
                <span className="homepage-psa__entry-num">01</span>
                <div className="homepage-psa__entry-body">
                  <div className="homepage-psa__entry-icon">
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <line x1="14" y1="22" x2="14" y2="26" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
                      <line x1="2" y1="14" x2="6" y2="14" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
                      <line x1="22" y1="14" x2="26" y2="14" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
                    </svg>
                  </div>
                  <div>
                    <p className="homepage-psa__entry-title">開始拍攝計算器</p>
                    <p className="homepage-psa__entry-desc">曝光 · 景深 · ND 濾鏡 · 日落時間</p>
                  </div>
                </div>
              </div>
              ...
              <div
                ...
                role="button"
                tabIndex={0}
                onKeyDown={(e) => (e.key === "Enter" || e.key === " ") && onFeatureSelect("analysis")}
              >
                <span className="homepage-psa__entry-num">02</span>
                <div className="homepage-psa__entry-body">
                  <div className="homepage-psa__entry-icon">
                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="3" y="18" width="4" height="8" stroke="currentColor" strokeWidth="1.2" />
                      <rect x="9" y="12" width="4" height="14" stroke="currentColor" strokeWidth="1.2" />
                      <rect x="15" y="8" width="4" height="18" stroke="currentColor" strokeWidth="1.2" />
                      <rect x="21" y="14" width="4" height="12" stroke="currentColor" strokeWidth="1.2" />
                      <line x1="2" y1="26" x2="26" y2="26" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" />
                    </svg>
                  </div>
                  <div>
                    <p className="homepage-psa__entry-title">進行拍攝後分析</p>
                    <p className="homepage-psa__entry-desc">風格分析 · Lightroom 調整建議</p>
                  </div>
                </div>
              </div>
            </div>
